...
Widok pozwala wybrać paletę oraz zakres automatyczny lub stały. Palety użytkownika domyślnie mają bezwzględne progi temperatury; automatyczna skala rozciąga je na bieżącą klatkę. Biel / czerwony szczyt oznacza górny zakres temperatur czerwienią. CLAHE i DDE zmieniają lokalny wygląd, więc legenda opisuje zaobserwowane pasma temperatur. Podświetlanie krawędzi zaznacza je na zielono, bez zmiany pomiarów i eksportów.
